<template>
	<view class="video_box">
		...
		<view class="play_btn" @click="onPlay">
			<image  class="icon_play"  v-if="playState == 1000" src="../../static/icon/ic_play.png" mode="aspectFit"></image>
		</view>
		<view class="play_schedule">
			<view class="schedule" :style="{width: schedule + '%'}">
				<view v-if="progressDrag" class="progress_drag_dot"></view>
			</view>
		</view>
	</view>
</template>
